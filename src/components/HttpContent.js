...
import API from "./API";
import Timechart from "./HttpCalls/Timechart";
import StatusPie from "./HttpCalls/StatusPie";
...
const HttpContent = () => {
  ...
  return (
    <div className="body-content--row">
      ...
      <div className="body-content--col body-content--graph">
        <Timechart requests={requests} />
        <StatusPie requests={requests} />
      </div>
    </div>
  );
};
